/**
 * infa2odi_ui_Objects - This class provides a graphical user interface (GUI) for connecting to Oracle Data Integrator (ODI),
 * allowing users to log in, choose source and target schemas, and select XML files for parsing and migration. 
 * It supports authentication, schema selection, and file selection functionalities.
 *
 * <p>
...
public class infa2odi_ui_Objects extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					infa2odi_ui_Objects frame = new infa2odi_ui_Objects();
	...
	public infa2odi_ui_Objects() {
		...
		//JLabel lblTmbExigiremosEl = new JLabel("tmb exigiremos el url del odi");
		//lblTmbExigiremosEl.setBounds(317, 82, 183, 14);
		//contentPane.add(lblTmbExigiremosEl);
		...
		btnBrowse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//fileChooser.setVisible(true);
				fileChooser.showOpenDialog(infa2odi_ui_Objects.this);
		...
		btnGoAhead.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(file!=null && file.exists()){
					infa2odi.infa_import_Objects.parsingFiles(odiInstanceHandle, cmbSourceLogicalSchema.getSelectedItem(), cmbTargetLogicalSchema.getSelectedItem(),file.getPath());
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				odiInstanceHandle =	infa2odi.infa_import_Objects.login(login_user_txt, login_pwd_txt, master_user_txt, master_pwd_txt);
				...
				lblRepository         .setVisible(false);
				lblPassword           .setVisible(false);
				lblWorkRepository     .setVisible(false);
		...
		//fileChooser.setBounds(161, 68, 582, 397);
